...
from processor.doc2vec.base.document_vectoraizer.builder_mixin.sequence_doc2vec.protocol import DocumentVectoraizerSequenceDoc2VecMixin
from processor.doc2vec.spacy.components.document_vectoraizer.cls import SpacyBasicDocumentVectoraizer
