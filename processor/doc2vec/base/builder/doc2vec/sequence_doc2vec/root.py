...
from processor.doc2vec.base.protocol.document_vectoraizor import AbstractDocumentVectoraizer
from processor.doc2vec.base.protocol.tokenizer import AbstarctTokenizerClass
