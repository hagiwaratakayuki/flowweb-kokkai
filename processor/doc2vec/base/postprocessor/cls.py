...
class Postprocessor(PostprocessorBase):
    ...
    def exec(self, parse_result: TokenDTO, data: DTO) -> ExecResponseType:
        ...
        keywords = self.keyword_extractor.exec(
            parse_result=parse_result, document_vector=document_vector, sentiment_results=sentiment_results, dto=data, token_2_vector=token_2_vector, postprocesser=self, mean_center=emphasized_mean_center)
