...
from regex import W
from doc2vec.base.protocol.keyword_extracter import ExtractResultDTO, StopwordRule
...
class Rule(StopwordRule, metaclass=ABCMeta):
    ...
    def execute(self, parse_result: any, document_vector: ndarray, sentiment_results: SentimentResult, dto: DTO, results: ExtractResultDTO, indexer: Any) -> List[SpecifiedKeyword]:
